...
export function activate(context: vscode.ExtensionContext) {
    context.subscriptions.push(
        vscode.commands.registerCommand('tategaki.openVerticalEditor', () => {
...
function getWebviewContent(initialText: string) {
    return `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
function updateOriginalFile(document: vscode.TextDocument, text: string) {
